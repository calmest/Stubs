    ...
    <div class="col-md-12">
        <div id="stub_wizard">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item">
                                ...
                                <div class="carousel-caption">
                                    ...
                                    <p><button class="select-tmpl btn btn-success btn-lg" data-tmpl="advanced" name="yt9" type="button">Select This Template</button></p>
                                </div>
                            </div>
                            <div class="carousel-item">
            ...
            <div id="stub_wizard_tab_2" class="tab-pane fade">
                ...
                <div id="tmpl-[tmpl]" class="tmpl-show">
                                        ...
                                        <tr>
                                                ...
                                                <td valign="top" align="center">
                                                    <span class="require" style="width:70%;">
                                                        <input type="text" name="stubs[stub][1][paymentDate]" id="paymentDate" placeholder="10/25/2018" value="10/25/2018" class="hasDatepicker" data-toggle="popover" data-placement="right" data-trigger="manual" data-content="<i class=&quot;fa fa-check&quot; aria-hidden=&quot;true&quot;></i>" data-html="true" data-original-title="" title=""><div class="popover fade right in" style="top: 1px; left: 98px; display: block;"><div class="arrow"></div><h3 class="popover-title" style="display: none;"></h3><div class="popover-content"><i class="fa fa-check" aria-hidden="true"></i></div></div>
                                                    </span>
                                                </td>
                                                <td valign="top" align="center">
                                ...
                                <div class="modal-body">
                                    <div class="options_block well">
                                        ...
                                        <div class="form-group" style="margin-bottom: 5px;">
                                            ...
                                            <input style="width: 120px;" type="text" class="form-control hasDatepicker" id="pre-paymentDate" value="10/25/2018">
                                        </div>
                                                            <div class="form-group" style="margin-bottom: 5px;">
                    ...
                    <script src="{{ asset('js/highlightsFields.js') }}" ></script>
                    <script type="text/javascript">
                    /*<![CDATA[*/
