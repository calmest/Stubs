...
@section('title', '| Classic 2 Template')
@section('content')
...
<h2>Classic2 Paycheck Stub Template</h2>
<hr>
...
background: url(/images/quality/classic2_w.jpg) no-repeat;
background-size: 105% 1077px;
...
.temp_easy{height:700px;}
.temp_ext{height: 991px;}
...
.ext_height {height: 314px;}
#temp #extendform {
display: none;
height: 258px;
margin: 36px 3.5% 0 3.5%;
}
#temp .ext_top {
height: 75px;
}
...
#temp #paymentDate,
#temp #employeeId {font-size: 13px;}
...
#stub_wizard .centered-arrow{top:380px;}
...
<div class="head_stub">
    ...
    <div class="right_head_stub">
            <input id="stubNumber" type="text" class="addtext addtext2" name="stubs[stub][1][stubNumber]">
...
<div class="stub_top">
  <div>
          <table cellspacing="0" cellpadding="0" border="0">
              ...
              <tr>
                    <td valign="top">
                        <div class="require" style="width:98%;">
                    ...
                    <td valign="top" align="center">
                        <div class="require" style="width:65%;">
                            <input type="text" class="addtext" name="stubs[header][ssn]" id="ssn" placeholder="XXX-XX-1234" value="XXX-XX-1234">
                        </div>
                    </td>
                    <td valign="top" align="center">
                        <input id="paymentPeriodDate" type="text" name="stubs[stub][1][paymentPeriodDate]" class="paymentPeriodDate" style="width:90%;margin-left: 2%;">
                    </td>
                    <td valign="top" align="center">
                        <span class="require" style="width:60%;">
...
<div>
  <table cellspacing="0" cellpadding="0" border="0">
                  <tbody><tr>
                      <th width="22%" style="text-align: left">INCOME</th>
                      <th width="9%">RATE</th>
                      <th width="8%">HOURS</th>
                      <th width="16%">CURRENT PAY</th>
                      <th width="21%">DEDUCTIONS</th>
                      <th width="11%">TOTAL</th>
                      <th width="13%">YTD TOTAL</th>
                  </tr>
                  <tr>
                      <td style="font-size:17px;">GROSS EARNINGS</td>
                        <td style="padding:0 1%;"><input id="payrate" type="text" name="stubs[header][payrate]" class="refreshable" value="11.47"></td>
                        <td style="padding:0 1%;"><input id="payhours" type="text" name="stubs[stub][1][payhours]" class="payhours"></td>
                        <td style="padding:0 2% 0 1%;"><input id="paythis" type="text" name="stubs[stub][1][paythis]" class="readonly refreshable" readonly="readonly"></td>
                        <td colspan="3" style="font-size:17px;">Statutory Deductions</td>
                  </tr>
                  <tr>
                      <td colspan="4"></td>
                      <td>Fica - Medicare</td>
                        <td><input type="text" name="stubs[stub][1][ficamedtax]" class="readonly line-up refreshable" id="ficamedtax" readonly="readonly"></td>
                        <td><input type="text" name="stubs[stub][1][ytdficamedtax]" class="readonly line-up refreshable" id="ytdficamedtax" readonly="readonly"></td>
                    </tr>
                  <tr>
                      <td colspan="4"></td>
                      <td>Fica - Social Security</td>
                        <td><input type="text" name="stubs[stub][1][ficasstax]" class="readonly line-up refreshable" id="ficasstax" readonly="readonly"></td>
                        <td><input type="text" name="stubs[stub][1][ytdficasstax]" class="readonly line-up refreshable" id="ytdficasstax" readonly="readonly"></td>
                    </tr>
                  <tr>
                      <td colspan="4"></td>
                      <td>Federal Tax W/H</td>
                        <td><input type="text" name="stubs[stub][1][ficafedtax]" class="readonly line-up refreshable" id="ficafedtax" readonly="readonly"></td>
                        <td><input type="text" name="stubs[stub][1][ytdficafedtax]" class="readonly line-up refreshable" id="ytdficafedtax" readonly="readonly"></td>
                                </tr>
...
<div>
  <table cellspacing="0" cellpadding="0" border="0">
    <tbody><tr>
                  <th width="17%">YTD GROSS</th>
                  <th width="18%">YTD DEDUCTIONS</th>
                  <th width="16%">YTD NET PAY</th>
                  <th width="16%">TOTAL</th>
                  <th width="17%">DEDUCTIONS</th>
                  <th width="16%">NET PAY</th>
              </tr>
              <tr>
                                          <td><input type="text" name="stubs[stub][1][ytdtotal]" class="readonly refreshable" id="ytdtotal" style="width:70%;" readonly="readonly"></td>
                    <td><input type="text" name="stubs[stub][1][ytddeductions]" class="readonly refreshable" id="ytddeductions" style="width: 60%;" readonly="readonly"></td>
                    <td><input type="text" name="stubs[stub][1][ytdnetpay]" class="readonly refreshable" id="ytdnetpay" style="width: 70%;" readonly="readonly"></td>
                    <td><input type="text" name="stubs[stub][1][total]" class="readonly refreshable" id="total" style="width: 70%;" readonly="readonly"></td>
                    <td><input type="text" name="stubs[stub][1][deductions]" class="readonly refreshable" id="deductions" style="width: 70%;" readonly="readonly"></td>
                    <td><input type="text" name="stubs[stub][1][netpay]" class="readonly refreshable" id="netpay" style="width: 75%;" readonly="readonly"></td>
                </tr>
  </tbody></table>
</div>
</div>
      ...
      <div id="extendform">
          ...
          <div class="ext_center">
            <div class="ext_center_left">
                <table cellspacing="0" cellpadding="0" border="0" style="width:100%;">
                    <tbody><tr>
                        <td width="15%" style="padding-right:2%;">PAY</td>
                        <td>
                            <div id="extpay">
                    ...
                    <tr>
                        <td valign="middle" style="font-size: 20px;padding-right:2%;">To the order of:</td>
                        <td>
...
<div class="modal-header">
  <div style="float:left;margin: 0 0 10px 0;">
    <div class="btn-group">
        ...
        <button onclick="$('#stubsForm').submit();" class="btn btn-primary" id="yw2" type="submit" name="yt4">Submit information</button>
    </div>
</div>
  <div style="float:right; margin: 0 0 10px 0;">
    <div class="btn-group">
        <button data-dismiss="modal" aria-label="Close" class="btn btn-default" id="yw3" name="yt5" type="button">Back to edit</button>
        <button onclick="$('#stubsForm').submit();" class="btn btn-primary" id="yw4" type="submit" name="yt6">Submit information</button>
    </div>
</div>
  <div class="clear"></div>
</div>
