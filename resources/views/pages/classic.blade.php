...
<div class="left_head_stub">
        <div class="require">
            <input id="companyName" type="text" class="addtext" name="stubs[header][companyName]" placeholder="Type Company Name Here" value="Type Company Name Here" data-val="Type Company Name Here">
        </div>
    ...
    <tr>
        <td valign="top">
            <div class="require" style="width:93%;">
                <input type="text" class="addtext" name="stubs[header][employeeName]" id="employeeName" placeholder="Type Employee Name Here" value="Type Employee Name Here">
                </div>
                <div class="require" style="width:93%;">
                    <input type="text" class="addtext" name="stubs[header][employeeAddress1]" id="employeeAddress1" placeholder="Type Employee Street Address Here" value="Type Employee Street Address Here">
                </div>
                                </td>
        ...
        <td align="center" valign="middle" style="padding: 0 1% 0 0;">
                ...
                <div class="require" style="width:70%">
                    <input type="text" class="addtext" id="employeeId" name="stubs[header][employeeId]" placeholder="123" value="123" maxlength="10" size="10">
                </div>
        </td>
    </tr>
</tbody></table>
