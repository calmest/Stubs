  ...
  <div class="collapse" id="collapse_options1">
      ...
      <div class="extend">
          ...
          <div id="change_template" style="display: inline-block;">
              <select name="stubs[header][templateBackground]" disabled="disabled" id="templateBackgroundModern3" class="form-control templateBackgroundAdvanced5">
                  <option value="/images/quality/modern3_w.jpg">Default</option>
                <option value="/images/quality/modern3_bg1_w.jpg">Template 1(+2.00)</option>
                <option value="/images/quality/modern3_bg2_w.jpg">Template 2(+2.00)</option>
                <option value="/images/quality/modern3_bg3_w.jpg">Template 3(+2.00)</option>
                <option value="/images/quality/modern3_bg4_w.jpg">Template 4(+2.00)</option>
            </select>
          </div>
      </div>
...
</form><div class="modal fade" id="PreviewStubs" tabindex="-1" role="dialog" aria-labelledby="PreviewStubs" aria-hidden="true" style="overflow-x: auto; display: none;">
