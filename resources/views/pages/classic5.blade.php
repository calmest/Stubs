    ...
    <tr>
      <td>
        <div class="require" style="width: 94%;">
            <input id="companyAddress1" type="text" class="addtext addtext2" name="stubs[header][companyAddress1]" placeholder="Company Address Line 1" value="Company Address Line 1">
          </div>
    </td>
      <td rowspan="3">
        <table cellspacing="0" cellpadding="0" border="0">
          ...
          <tr>
            <td>
            <div class="require" style="width: 92%;">
                  <input id="employeeAddress2" type="text" class="addtext addtext2" name="stubs[header][employeeAddress2]" placeholder="Employee Address Line 2" value="Employee Address Line 2">
                </div>
                                </td>
      ...
      <td align="center">
        <input type="text" name="stubs[stub][1][paymentPeriodDate]" id="paymentPeriodDate" class="paymentPeriodDate" value="11/05/2018 - 11/11/2018">
    </td>
    </tr>
    <tr>
      <td>
        <div class="require" style="width: 94%;">
            <input id="companyAddress2" type="text" class="addtext addtext2" name="stubs[header][companyAddress2]" placeholder="Company Address Line 2" value="Company Address Line 2">
        </div>
    </td>
