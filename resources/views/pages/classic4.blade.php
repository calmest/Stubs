...
steps: [{
  ...
  intro: 'Enter company name'
        ...
        {
    element: '#companyAddress1',
    intro: 'Company address'
  },{
    element: '#companyAddress2',
    intro: 'Company address'
  },
      {
  element: '#paymentDate',
          ...
          <table class="stub_top" cellspacing="0" cellpadding="0" border="0">
              ...
              <tr>
                      ...
                      <td valign="top" align="center">
                          <input type="text" name="stubs[stub][1][paymentPeriodDate]" id="paymentPeriodDate" style="width:90%;margin-left: 8px;" class="paymentPeriodDate" value="11/05/2018 - 11/11/2018">
                      </td>
                      <td valign="top" align="center">
