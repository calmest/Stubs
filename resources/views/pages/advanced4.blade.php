  ...
  <div class="collapse" id="collapse_options1">
      ...
      <div class="extend">
          ...
          <div id="change_template" style="display: inline-block;">
              <select name="stubs[header][templateBackground]" disabled="disabled" id="templateBackgroundAdvanced4" class="form-control templateBackgroundAdvanced5">
                <option value="/images/quality/advanced4_w.jpg">Default</option>
                <option value="/images/quality/advanced4_bg1_w.jpg">Template 1(+2.00)</option>
                <option value="/images/quality/advanced4_bg2_w.jpg">Template 2(+2.00)</option>
                <option value="/images/quality/advanced4_bg3_w.jpg">Template 3(+2.00)</option>
                <option value="/images/quality/advanced4_bg4_w.jpg">Template 4(+2.00)</option>
              </select>
          </div>
      </div>
                  <div class="clearfix"></div>
                  ...
                  <table cellspacing="0" cellpadding="0" border="0" width="100%">
                      ...
                      <tr>
                          ...
                          <td class="top_stub_right_table_center_tax_id">
                                <div class="require" style="width:94%;">
                                      <input type="text" name="stubs[header][taxid]" id="taxid" placeholder="XX-XXXXXXX" value="00-0000001" >
                                  </div>
                            </td>
...
<!--                                    -->                                </td>
                          ...
                          <td class="top_stub_right_table_center_paymentDate">
                                <div class="require" style="width:94%;">
                                      <input type="text" name="stubs[stub][1][paymentDate]" id="paymentDate" data-template-pdf="advanced4" placeholder="11/13/2018" value="11/13/2018">
                                  </div>
                            </td>
                      </tr>
                  </tbody></table>
