...
<h2>Classic6 Paycheck Stub Template</h2>
<hr>
...
background: url(/images/quality/classic6_w.jpg) no-repeat;
...
.temp_easy {height: 766px;}
.temp_ext {height: 925px;}
...
<div class="left_head_stub">
    ...
    <div class="require" id="companyAddress">
      <input id="companyAddress1" type="text" class="addtext" name="stubs[header][companyAddress1]" placeholder="Company Address Line 1" value="Company Address Line 1">
    </div>
  </div>
  ...
  <table cellspacing="0" cellpadding="0" border="0">
    ...
    <tr>
        <td valign="top">
          ...
          <div class="require" style="width:95%;">
            <input id="employeeAddress1" type="text" class="addtext addtext2" name="stubs[header][employeeAddress1]" placeholder="Employee Address Line 1" value="Employee Address Line 1"><br>
          </div>
        </td>
        <td valign="top" align="center">
          <div class="require" style="width:82%;">
            <input type="text" class="addtext" name="stubs[header][ssn]" id="ssn" placeholder="XXX-XX-1234" value="XXX-XX-1234">
          </div>
        </td>
        <td valign="top" align="center">
          <input type="text" style="width: 94%;text-align: center;" name="stubs[stub][1][paymentPeriodDate]" id="paymentPeriodDate" class="paymentPeriodDate">
        </td>
        <td valign="top" align="center">
...
<div class="clearfix"></div>
<input type="hidden" value="classic6" name="stubs[template]">
...
<div class="modal-body">
  ...
  <div data-tmpl="classic6" id="carusel_preview" class="carousel slide">
    <div class="carousel-inner"></div>
    <a class="carousel-control left" href="#carusel_preview" data-slide="prev">
      <span class="glyphicon glyphicon-chevron-left"></span>
    </a>
    <a class="carousel-control right" href="#carusel_preview" data-slide="next">
