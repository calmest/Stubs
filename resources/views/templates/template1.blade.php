...
<html lang="en">
    <head>
        ...
        <meta name="msapplication-config" content="https://www.realcheckstubs.com/browserconfig.xml" />

        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="stylesheet" type="text/css" href="https://www.realcheckstubs.com/assets/45269915/bootstrap/css/bootstrap.min.css" />
        <link rel="stylesheet" type="text/css" href="https://www.realcheckstubs.com/assets/45269915/css/bootstrap-yii.css" />
        <link rel="stylesheet" type="text/css" href="https://www.realcheckstubs.com/assets/45269915/css/jquery-ui-bootstrap.css" />
        <link rel="stylesheet" type="text/css" href="https://www.realcheckstubs.com/css/jquery.bxslider.css" />
        <link rel="stylesheet" type="text/css" href="https://www.realcheckstubs.com/css/introjs.css" />
        <link rel="stylesheet" type="text/css" href="https://www.realcheckstubs.com/css/template-btn.css" />
        <link rel="stylesheet" type="text/css" href="/assets/c5f2d3eb/rating/jquery.rating.css" />
        <script type="text/javascript" src="https://www.realcheckstubs.com/js/jquery-1.9.1.min.js"></script>
        <script type="text/javascript" src="https://www.realcheckstubs.com/assets/45269915/bootstrap/js/bootstrap.min.js"></script>
        <script type="text/javascript" src="https://www.realcheckstubs.com/assets/45269915/js/bootstrap-noconflict.js"></script>
        <script type="text/javascript" src="https://www.realcheckstubs.com/assets/45269915/bootbox/bootbox.min.js"></script>
        <script type="text/javascript" src="https://www.realcheckstubs.com/assets/45269915/notify/notify.min.js"></script>
        <script type="text/javascript" src="https://www.realcheckstubs.com/assets/45269915/js/jquery-ui-no-conflict.min.js"></script>
        <script type="text/javascript" src="https://www.realcheckstubs.com/assets/c5f2d3eb/jquery.yiiactiveform.js"></script>
        <script type="text/javascript" src="https://www.realcheckstubs.com/assets/c5f2d3eb/jquery.metadata.js"></script>
        <script type="text/javascript" src="https://www.realcheckstubs.com/assets/c5f2d3eb/jquery.rating.js"></script>
        <script type="text/javascript" src="https://www.realcheckstubs.com/js/intro.js"></script>
        <script type="text/javascript" src="https://www.realcheckstubs.com/js/characterLimitFields.js"></script>
        <script type="text/javascript" src="https://www.realcheckstubs.com/js/moment.min.js"></script>
        ...
        <script type="text/javascript" src="https://www.realcheckstubs.com/js/protected/classStubs.js"></script>
        ...
        <title>Real Paycheck Stubs | Modern Stub</title>
        ...
        <link rel="stylesheet" type="text/css" href="https://www.realcheckstubs.com/css/font-awesome.min.css">
        <link rel="stylesheet" type="text/css" href="https://www.realcheckstubs.com/css/main.css">
    ...
    <body>
                        ...
                        <div class="col-sm-8">
                            <div class="left-th">
                                <a href="/" class="stub-logo">
                                    <img src="https://www.realcheckstubs.com/images/stublogo.png" width="400" height="100" alt="Real Check Stub Logo">
                                </a>
        ...
        <button data-toggle="modal" data-target="#register_win" class="btn btn-success" name="yt7" type="button">Register</button><button data-toggle="modal" data-target="#login_win" class="btn btn-default" name="yt8" type="button">Sign in</button></div>
...
<div class="modal-body">
    <form class="well form" id="login_form" action="https://www.realcheckstubs.com/personal/login" method="post">        <div id="signin_message">
        ...
        <button id="register_btn" class="pull-left btn btn-default" name="yt9" type="button">Register</button><button class="pull-right btn btn-success" type="submit" name="yt10">Login</button>        <div class="clear"></div>
    </form></div>
...
<div class="modal-body">
    <form class="well form" id="reset_pass_form" action="https://www.realcheckstubs.com/personal/passwordreset" method="post">
        ...
        <div class="form-group">
        <div class="form-group">
            <input placeholder="Email" id="ResetPassword_email" class="form-control" name="LoginForm[username]" type="email" /><div class="help-block error" id="LoginForm_username_em_" style="display:none"></div></div>        </div>
        <div class="text-center">
            <button class="btn btn-success" type="submit" name="yt11">Send password reset email</button>        </div>
        <div class="clear"></div>
    </form></div>
...
</div></div></div><div id="register_win" class="modal fade"><div class="modal-dialog modal-sm"><div class="modal-content"><div class="modal-header">
    <a class="close" data-dismiss="modal">&times;</a>
    <h4>Register</h4>
</div>
    ...
    $(document).on('click', '#login_btn', function () {
        ...
        $('#register_win').modal('hide');
                ...
                <div class="main-top">
                    ...
                    <div class="top-menu">
                        <nav class="navbar navbar-default"><div class="container"><div class="navbar-header"><button class="navbar-toggle btn btn-default" data-toggle="collapse" data-target="#yii_booster_collapse_yw5" id="yw6" name="yt14" type="button"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class=" navbar-brand" href="/">Home</a></div><div class="collapse navbar-collapse" id="yii_booster_collapse_yw5"><ul id="yw7" class="nav navbar-nav">
<li>
    ...
    <div class="col-xs-3">
        <div class="watch-demo well">
            ...
            <div id="btn-modal-watch-demo">
                <img src="https://www.realcheckstubs.com/images/thumbnail.jpg" />
            </div>
...
<script>
    ...
    <br>
        ...
        <a href="/modern/"><img src="https://www.realcheckstubs.com/images/min_modern.jpeg" width="100"/></a>
        <span class="insert turquoise"><b>Modern</b></span>
    </div>
            <div class="sleeve ">
        <a href="/modern2/"><img src="https://www.realcheckstubs.com/images/min_modern2.jpeg" width="100"/></a>
        <span class="insert turquoise2"><b>Modern2</b></span>
    </div>
            <div class="sleeve ">
        <a href="/modern3/"><img src="https://www.realcheckstubs.com/images/min_modern3.jpeg" width="100"/></a>
        <span class="insert blue"><b>Modern3</b></span>
    </div>
                <div class="sleeve ">
        <a href="/classic/"><img src="https://www.realcheckstubs.com/images/min_classic.jpeg" width="100"/></a>
        <span class="insert blue2"><b>Classic</b></span>
    </div>
            <div class="sleeve ">
        <a href="/classic2/"><img src="https://www.realcheckstubs.com/images/min_classic2.jpeg" width="100"/></a>
        <span class="insert purpure"><b>Classic2</b></span>
    </div>
            <div class="sleeve ">
        <a href="/classic3/"><img src="https://www.realcheckstubs.com/images/min_classic3.jpeg" width="100"/></a>
        <span class="insert purpure2"><b>Classic3</b></span>
    </div>
            <div class="sleeve ">
        <a href="/classic4/"><img src="https://www.realcheckstubs.com/images/min_classic4.jpeg" width="100"/></a>
        <span class="insert purpure3"><b>Classic4</b></span>
    </div>
            <div class="sleeve ">
        <a href="/classic5/"><img src="https://www.realcheckstubs.com/images/min_classic5.jpeg" width="100"/></a>
        <span class="insert pink"><b>Classic5</b></span>
    </div>
            <div class="sleeve ">
        <a href="/classic6/"><img src="https://www.realcheckstubs.com/images/min_classic6.jpeg" width="100"/></a>
        <span class="insert pink2"><b>Classic6</b></span>
    </div>
            <div class="sleeve ">
        <a href="/advanced/"><img src="https://www.realcheckstubs.com/images/min_advanced.jpeg" width="100"/></a>
        <span class="insert pink3"><b>Advanced</b></span>
    </div>
            <div class="sleeve ">
        <a href="/advanced2/"><img src="https://www.realcheckstubs.com/images/min_advanced2.jpeg" width="100"/></a>
        <span class="insert pink4"><b>Advanced2</b></span>
    </div>
            <div class="sleeve ">
        <a href="/advanced3/"><img src="https://www.realcheckstubs.com/images/min_advanced3.jpeg" width="100"/></a>
        <span class="insert red"><b>Advanced3</b></span>
    </div>
            <div class="sleeve ">
        <a href="/advanced4/"><img src="https://www.realcheckstubs.com/images/min_advanced4.jpeg" width="100"/></a>
...
<hr>
<button class="btn btn-primary" id="call-mobile-modal" name="yt1" type="button">Quick options window</button><br>
<form class="form" id="stubsForm" action="/modern/" method="post"><div class="options_block well">
        <div class="row">
            <div class="col-sm-10">
    ...
    #temp {
        ...
        background: url(https://www.realcheckstubs.com/images/quality/modern_w.jpg) no-repeat;
    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="container">
            <div class="row">
                            ...
                            <header>
                                <span class="review-header">manager</span>
                                <span class="review-time">
                                    <span class="bullet time-ago-bullet" aria-hidden="true">&bullet;</span>
                                    4 days ago                              </span>
                            </header>
                            <div class="rating-blog">
                                <span id="1155">
<input id="1155_0" value="1" type="radio" name="1155" />
<input id="1155_1" value="2" type="radio" name="1155" />
<input id="1155_2" value="3" type="radio" name="1155" />
<input id="1155_3" value="4" type="radio" name="1155" />
<input id="1155_4" value="5" checked="checked" type="radio" name="1155" />
</span>                             <div class="clearfix"></div>
                            </div>
                        </div>
                        <div class="review-message">
                            <p>they are always on point!</p>
                        </div>
                        <div class="reviewer-name">
                            Princess Caceres                        </div>
                    </div>
                                        <div class="personal-menu col-sm-4 col-xs-12 review-block" style="border:0;">
                                                <div class="review-body" style="padding-left: 0;">
                            <header>
                                <span class="review-header">Tami</span>
                                <span class="review-time">
                                    <span class="bullet time-ago-bullet" aria-hidden="true">&bullet;</span>
                                    5 days ago                              </span>
                            </header>
                            <div class="rating-blog">
                                <span id="1154">
<input id="1154_0" value="1" type="radio" name="1154" />
<input id="1154_1" value="2" type="radio" name="1154" />
<input id="1154_2" value="3" type="radio" name="1154" />
<input id="1154_3" value="4" type="radio" name="1154" />
<input id="1154_4" value="5" checked="checked" type="radio" name="1154" />
</span>                             <div class="clearfix"></div>
                            </div>
                        </div>
                        <div class="review-message">
                            <p>Very pleased. Accurate and professional. Quick and easy. Will use again</p>
                        </div>
                        <div class="reviewer-name">
                            Tami                        </div>
                    </div>
                                        <div class="personal-menu col-sm-4 col-xs-12 review-block" style="border:0;">
                                                <div class="review-body" style="padding-left: 0;">
                            <header>
                                <span class="review-header">Great Job</span>
                                <span class="review-time">
                                    <span class="bullet time-ago-bullet" aria-hidden="true">&bullet;</span>
                                    5 days ago                              </span>
                            </header>
                            <div class="rating-blog">
                                <span id="1152">
<input id="1152_0" value="1" type="radio" name="1152" />
<input id="1152_1" value="2" type="radio" name="1152" />
<input id="1152_2" value="3" type="radio" name="1152" />
<input id="1152_3" value="4" type="radio" name="1152" />
<input id="1152_4" value="5" checked="checked" type="radio" name="1152" />
</span>                             <div class="clearfix"></div>
                            </div>
                        </div>
                        <div class="review-message">
                            <p>This looks very professional and I got it very fast . Thank you very much</p>
                        </div>
                        <div class="reviewer-name">
                            Lauren Cooney                       </div>
                    </div>
                ...
                <div class="container footer-container">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="verasafe-img" type="image" onclick="getInstantVerification('64A97C19A61AAA5', 'https://www.verasafe.com/');" src="https://www.realcheckstubs.com/images/verasafe.png" alt="VeraSafe Trust Seal">
                            <a class="paypal-secured-img" href="https://www.paypal.com/webapps/mpp/paypal-popup" title="How PayPal Works" onclick="[removed]window.open('https://www.paypal.com/webapps/mpp/paypal-popup','WIPaypal','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=1060, height=700'); return false;">
                                <img src="https://www.realcheckstubs.com/images/paypal_secured.png" alt="Secured by PayPal" border="0">
                            </a>
                            <a class="paypal-img" href="https://www.paypal.com/webapps/mpp/paypal-popup" title="How PayPal Works" onclick="[removed]window.open('https://www.paypal.com/webapps/mpp/paypal-popup','WIPaypal','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=1060, height=700'); return false;">
                                <img src="https://www.realcheckstubs.com/images/paypal.jpeg" alt="PayPal Acceptance Mark" border="0">
                            </a>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                    <p style="text-align:center;margin-top: 10px;font-size: 10px;">&COPY; Real Check Stubs 2018</p>
                </div>
            </div>
        </div>
