<div id="tmpl-advanced2" class="tmpl-show" style="display: block;">
    ...
    <form class="form" id="stubsForm" action="/generateStubs/selecttpl?template=advanced2" method="post"><div class="options_block well">
            <div class="row">
                <div class="col-sm-10">
