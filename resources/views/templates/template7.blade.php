<div id="tmpl-classic4" class="tmpl-show" style="display: block;"><script type="text/javascript" src="/js/classStubs.js"></script>
    <script type="text/javascript" src="/js/modalStubs.js"></script>
    <script type="text/javascript" src="/js/generateStubs.js"></script>
    <h2>Classic4 Paycheck Stub Template</h2>
    <hr>
    <button class="btn btn-primary" id="call-mobile-modal" name="yt0" type="button" style="display: none;">Quick options window</button><br>
    <form class="form" id="stubsForm" action="/generateStubs/selecttpl?template=classic4" method="post"><div class="options_block well">
            <div class="row">
                <div class="col-sm-10">
        ...
        .all_preset{padding: 0 20px 0 10px;}
        #carusel_preview .all_preset{padding: 0;}
        #temp {
            font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;
            background: url(/images/quality/classic4_w.jpg) no-repeat;
            ...
            padding: 0;
                ...
                .temp_easy {height: 687px;}
            .temp_ext {height: 1007px;}
        ...
        #stub_wizard .centered-arrow{top:330px;}
        ...
        <div class="temp_easy" id="temp">
            <div class="top1">
                <div class="top1_l">
                        ...
                        <div class="require">
                            <input id="companyAddress1" type="text" class="addtext addtext2" name="stubs[header][companyAddress1]" placeholder="Type Company Street Address Here" value="Type Company Street Address Here" data-val="Type Company Street Address Here" data-toggle="popover" data-placement="right" data-trigger="manual" data-content="<i class=&quot;fa fa-check&quot; aria-hidden=&quot;true&quot;></i>" data-html="true" data-original-title="" title=""><div class="popover fade right in" style="top: 1px; left: 98px; display: block;"><div class="arrow"></div><h3 class="popover-title" style="display: none;"></h3><div class="popover-content"><i class="fa fa-check" aria-hidden="true"></i></div></div>
                        </div>
                                </div>
                <div class="top1_c">
                    <p>Earnings Statement&nbsp;&nbsp;&nbsp;#
                                        <input type="text" id="stubNumber" class="addtext addtext2" name="stubs[stub][1][stubNumber]"></p>
                                </div>
                <div class="top1_r">
                                        <div class="require">
            ...
            <div class="top2">
                <div class="top2_l">
                                        <div class="require">
                            <textarea id="companyAddress2" class="addtext addtext2" name="stubs[header][companyAddress2]" placeholder="Type Company City Address Here" data-val="Type Company City Address Here" data-toggle="popover" data-placement="right" data-trigger="manual" data-content="<i class=&quot;fa fa-check&quot; aria-hidden=&quot;true&quot;></i>" data-html="true" data-original-title="" title="">Type Company City Address Here</textarea><div class="popover fade right in" style="top: 1px; left: 98px; display: block;"><div class="arrow"></div><h3 class="popover-title" style="display: none;"></h3><div class="popover-content"><i class="fa fa-check" aria-hidden="true"></i></div></div>
                        </div>
                                </div>
                <div class="top2_c">
                    <table class="stub_top" cellspacing="0" cellpadding="0" border="0">
                        <tbody><tr>
                            <th width="15.5%">ssn</th>
                            <th width="22%">reporting period</th>
                        ...
                        <tr>
                                                        <td valign="top">
                                    <div class="require" style="width:70%;margin-left: 15%;">
                                ...
                                <td valign="top" align="center">
                                    <input type="text" name="stubs[stub][1][paymentPeriodDate]" id="paymentPeriodDate" style="width:90%;margin-left: 8px;" class="paymentPeriodDate" value="11/04/2018 - 11/10/2018">
                                </td>
                                <td valign="top" align="center">
                                    <div class="require" style="width:70%;margin-left: 10%;">
                ...
                <div class="top2_r">
                                        <div class="require">
                            <textarea rows="2" class="addtext addtext2" name="stubs[header][employeeAddress2]" id="employeeAddress2" style="height: 70px;max-height: 70px;" placeholder="Type Employee City Address Here" data-val="Type Employee City Address Here" data-toggle="popover" data-placement="right" data-trigger="manual" data-content="<i class=&quot;fa fa-check&quot; aria-hidden=&quot;true&quot;></i>" data-html="true" data-original-title="" title="">Type Employee City Address Here</textarea><div class="popover fade right in" style="top: 1px; left: 98px; display: block;"><div class="arrow"></div><h3 class="popover-title" style="display: none;"></h3><div class="popover-content"><i class="fa fa-check" aria-hidden="true"></i></div></div>
                        </div>
                                </div>
                <div class="clear"></div>
            </div>
            <div class="stub_center">
                <div>
                    <table cellspacing="0" cellpadding="0" border="0">
                        <tbody><tr>
                            <th width="22%">INCOME</th>
                            <th width="10%">RATE</th>
                            <th width="9%">HOURS</th>
                            <th width="13%">CURRENT PAY</th>
                            <th width="24%">DEDUCTIONS</th>
                            <th width="11%">TOTAL</th>
                            <th width="11%">YTD TOTAL</th>
                        </tr>
                        <tr>
                            <td valign="top" style="padding-left:20px;">GROSS EARNINGS</td>
                                ...
                                <td style="padding-left:1%;">
                                    <input type="text" name="stubs[stub][1][paythis]" class="readonly refreshable" id="paythis" style="width:85%;" readonly="readonly">
                                </td>
                                                    <td style="padding-left:10px;" colspan="3">Statutory Deductions</td>
                        </tr>
                        <tr>
                            <td colspan="4"></td>
                            <td style="padding-left:10px;font-weight: normal;">Fica - Medicare</td>
                                                        <td style="padding-left:1%;">
                        ...
                        <tr>
                            <td colspan="4"></td>
                            <td style="padding-left:10px;font-weight: normal;">Fica - Social Security</td>
                                                        <td style="padding-left:1%;">
                        ...
                        <tr>
                            <td colspan="4"></td>
                            <td style="padding-left:10px;font-weight: normal;">Federal Tax</td>
                                                        <td style="padding-left:1%;">
                                ...
                                <td id="stateAbbrId" style="padding-left:1%;font-weight: normal;">State Tax W/H</td>
                                <td style="padding-left:1%;">
                            ...
                            <tr class="casdi_tr casdi_tr_hide">
                                <td colspan="4"></td>
                                <td style="padding-left:1%;font-weight: normal;">California SDI Tax</td>
                                <td style="padding-left:1%;">
            ...
            <div class="stub_total">
                <div>
                    <table cellspacing="0" cellpadding="0" border="0">
                        <tbody><tr>
                            <th width="15%">YTD GROSS</th>
                            <th width="20%">YTD DEDUCTIONS</th>
                        ...
                        <tr>
                                ...
                                <td><input type="text" name="stubs[stub][1][ytddeductions]" class="readonly refreshable" id="ytddeductions" style="width: 85%;" readonly="readonly"></td>
                                ...
                                <td><input type="text" name="stubs[stub][1][deductions]" class="readonly refreshable" id="deductions" style="width: 85%;" readonly="readonly"></td>
    ...
    <script type="text/javascript">
        ...
        <div class="clearfix"></div>
        <input type="hidden" value="classic4" name="stubs[template]">
