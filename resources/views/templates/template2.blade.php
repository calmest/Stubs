<div id="tmpl-modern2" class="tmpl-show" style="display: block;"><script type="text/javascript" src="/js/classStubs.js"></script>
    ...
    <form class="form" id="stubsForm" action="/generateStubs/selecttpl?template=modern2" method="post"><div class="options_block well">
            <div class="row">
                <div class="col-sm-10">
            ...
            <div class="collapse" id="collapse_options1">
                ...
                <div class="extend">
                    ...
                    <div id="change_template" style="display: inline-block;">
                        <select name="stubs[header][templateBackground]" disabled="disabled" id="templateBackgroundModern2" class="form-control templateBackgroundAdvanced5"><option value="modern2_w.jpg">Default</option><option value="modern2_bg1_w.jpg">Template 1(+2.00)</option><option value="modern2_bg2_w.jpg">Template 2(+2.00)</option><option value="modern2_bg3_w.jpg">Template 3(+2.00)</option><option value="modern2_bg4_w.jpg">Template 3(+2.00)</option></select>
                    </div>
                </div>
