<div id="tmpl-modern3" class="tmpl-show" style="display: block;"><script type="text/javascript" src="/js/classStubs.js"></script>
    <script type="text/javascript" src="/js/modalStubs.js"></script>
    <script type="text/javascript" src="/js/generateStubs.js"></script>
    <h2>Modern3 Paycheck Stub Template</h2>
    <hr>
    <button class="btn btn-primary" id="call-mobile-modal" name="yt0" type="button" style="display: none;">Quick options window</button><br>
    <form class="form" id="stubsForm" action="/generateStubs/selecttpl?template=modern3" method="post"><div class="options_block well">
            <div class="row">
                <div class="col-sm-10">
            ...
            <div class="collapse" id="collapse_options1">
                ...
                <div class="extend">
                    ...
                    <div id="change_template" style="display: inline-block;">
                        <select name="stubs[header][templateBackground]" disabled="disabled" id="templateBackgroundModern3" class="form-control templateBackgroundAdvanced5"><option value="modern3_w.jpg">Default</option><option value="modern3_bg1_w.jpg">Template 1(+2.00)</option><option value="modern3_bg2_w.jpg">Template 2(+2.00)</option><option value="modern3_bg3_w.jpg">Template 3(+2.00)</option><option value="modern3_bg4_w.jpg">Template 4(+2.00)</option></select>
                    </div>
                </div>
        ...
        #temp {
            background: url(/images/quality/modern3_w.jpg) no-repeat;
        ...
        .clear {clear: both;}
        .temp_easy {height: 449px;}
        .temp_ext {height: 568px;}
        ...
        #temp #extabbreviation{
            ...
            padding-left: 4px;
            vertical-align: bottom;
            padding-bottom: 4px;    line-height: 20px;    font-family: "OCRAEXT";    }
        ...
        <div class="all_preset" id="all_preset1">
                ...
                <div class="stub_total">
                    <div style="float: left;width: 35.7%;height: 63px;">
                        <table style="height: 63px;" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                            <tr>
                                <td width="52%" id="extabbreviation" class="ext_div" data-old="
                                                                ">
                                                                </td>
                                <td width="48%" style="" id="extcompanyAddress1" class="ext_div" data-old="
                                    Type Company Street Address Here                            ">Type Company Street Address Here</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
                    <div style="float: right;height: 63px;width: 64.2%;padding-top: 16px;">
                        <table style="height: 47px;" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                            <tr>
                                <td class="right_stub_total_titel_ytdgross" width="17.5%" height="19px">YTD GROSS</td>
                                <td class="right_stub_total_titel_ytddeductions" width="17%" height="19px">YTD DEDUCTIONS</td>
                                <td class="right_stub_total_titel_ytdnetpay" width="17%" height="19px">YTD NET PAY</td>
                                <td class="right_stub_total_titel_total" width="16.5%" height="19px">TOTAL</td>
                                <td class="right_stub_total_titel_deductions" width="16%" height="19px">DEDUCTIONS</td>
    ...
    <script type="text/javascript">
        ...
        <div class="clearfix"></div>
        <input type="hidden" value="modern3" name="stubs[template]">
