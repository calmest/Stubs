<div id="tmpl-advanced3" class="tmpl-show" style="display: block;">
    ...
    <form class="form" id="stubsForm" action="/generateStubs/selecttpl?template=advanced3" method="post"><div class="options_block well">
            <div class="row">
                <div class="col-sm-10">
                    ...
                    <div class="top_ls">
                        <div class="grey_box">
                                ...
                                <span class="require" style="margin-right: 4%; width:22%;">
                                    <input type="text" id="ssn" class="addtext" name="stubs[header][ssn]" placeholder="XXX-XX-1234" value="XXX-XX-1234" data-val="XXX-XX-1234" data-toggle="popover" data-placement="right" data-trigger="manual" data-content="<i class=&quot;fa fa-check&quot; aria-hidden=&quot;true&quot;></i>" data-html="true" data-original-title="" title=""><div class="popover fade right in" style="top: 1px; left: 98px; display: block;"><div class="arrow"></div><h3 class="popover-title" style="display: none;"></h3><div class="popover-content"><i class="fa fa-check" aria-hidden="true"></i></div></div>
                                </span>
                ...
                <div class="right_side">
                    <div class="top_rs">
                        ...
                        <div class="period_day">
                                ...
                                <span class="require">
                                    <input type="text" name="stubs[stub][1][paymentDate]" id="paymentDate" placeholder="11/12/2018" value="11/12/2018" style="width:90px;" class="hasDatepicker" data-toggle="popover" data-placement="right" data-trigger="manual" data-content="<i class=&quot;fa fa-check&quot; aria-hidden=&quot;true&quot;></i>" data-html="true" data-original-title="" title=""><div class="popover fade right in" style="top: 1px; left: 98px; display: block;"><div class="arrow"></div><h3 class="popover-title" style="display: none;"></h3><div class="popover-content"><i class="fa fa-check" aria-hidden="true"></i></div></div>
                                </span>
                                <div class="clear"></div>
