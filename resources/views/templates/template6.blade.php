<div id="tmpl-classic3" class="tmpl-show" style="display: block;"><script type="text/javascript" src="/js/classStubs.js"></script>
    ...
    <form class="form" id="stubsForm" action="/generateStubs/selecttpl?template=classic3" method="post"><div class="options_block well">
            <div class="row">
                <div class="col-sm-10">
